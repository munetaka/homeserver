...
# https://www.tepco.co.jp/ep/private/fuelcost2/newlist/index-j.html (2026-08-17 取得)
# 必ず「電気・ガス料金支援 **反映前**」の単価を登録すること。TEPCO の一覧・お知らせには
# 反映後の単価も並んでいるが、支援値引きは SUBSIDY_YEN で別管理しているため、
# 反映後を入れると二重計上になる (2026-08 で実際にやらかした →
# docs/incidents/2026-08-17-tariff-subsidy-double-count.md)
FUEL_ADJUSTMENT_YEN = {
    ...
    "2026-05": -7.37, "2026-06": -7.30, "2026-07": -7.19,
    "2026-08": -6.77,  # 反映後は -10.27 (支援 -3.50)
    "2026-09": -6.46,  # 反映後は -10.96 (支援 -4.50)
}
